 ...
 * @property {object} [zone] - BR zone stub data.
 ...
 * @property {(state: { kills?: number, teamKills?: object, captures?: object, aliveCount?: number, [key: string]: any }) => boolean} checkWin - Returns true when the match should end.
